...
<body>
	...
	<form action="" method="POST">
		<header><h1 style="text-align: center;"></h1>
		...
		<div class="recover">
			...
			<input style="background-color: #4CAF50; border: none; padding: 15px 32px; text-decoration: none; display: inline-block; font-size: 16px; margin: 4px 2px; cursor: pointer;" type="submit" name="submit"><a href="http:/conference/users/submit_code_user.php">submit code</a>
